...
INSERT INTO products (id, category_id, name, description, price, stock, view_count, status, created_at, updated_at)
VALUES
    (1, 1, 'Galaxy S25 256GB', '6.7인치 AMOLED 디스플레이와 고성능 카메라를 갖춘 스마트폰입니다.', 1290000, 35, 1280, 'ON_SALE', NOW(), NULL),
    (2, 1, 'iPhone 16 128GB', '일상 촬영과 빠른 앱 실행에 적합한 프리미엄 스마트폰입니다.', 1250000, 28, 1540, 'ON_SALE', NOW(), NULL),
    (3, 1, 'Pixel 9 Pro 256GB', '깔끔한 안드로이드 경험과 사진 보정 기능이 강점인 스마트폰입니다.', 1190000, 14, 860, 'ON_SALE', NOW(), NULL),
    (4, 2, 'Galaxy Tab S10 11형', '영상 시청, 필기, 가벼운 업무에 적합한 태블릿입니다.', 890000, 22, 620, 'ON_SALE', NOW(), NULL),
    (5, 2, 'iPad Air 11형 128GB', '얇고 가벼운 디자인의 다목적 태블릿입니다.', 929000, 18, 970, 'ON_SALE', NOW(), NULL),
    (6, 2, 'Lenovo Tab Plus 128GB', '가성비 좋은 엔터테인먼트용 안드로이드 태블릿입니다.', 329000, 40, 310, 'ON_SALE', NOW(), NULL),
    (7, 3, 'LG Gram 16 2026', '가벼운 무게와 긴 배터리 시간을 제공하는 16형 노트북입니다.', 1790000, 12, 740, 'ON_SALE', NOW(), NULL),
    (8, 3, 'MacBook Air 13 M4', '휴대성과 성능을 모두 갖춘 13형 노트북입니다.', 1590000, 16, 1380, 'ON_SALE', NOW(), NULL),
    (9, 3, 'ThinkPad X1 Carbon', '업무용으로 안정적인 성능과 내구성을 갖춘 노트북입니다.', 2190000, 7, 530, 'ON_SALE', NOW(), NULL),
    (10, 3, 'ASUS VivoBook 15', '학생과 사무용 사용자에게 적합한 실속형 노트북입니다.', 790000, 25, 420, 'ON_SALE', NOW(), NULL),
    (11, 4, 'HP Pavilion Desktop', '가정과 사무실에서 사용하기 좋은 데스크탑 PC입니다.', 890000, 10, 190, 'ON_SALE', NOW(), NULL),
    (12, 4, 'Gaming Desktop RTX 4060', 'FHD 게이밍과 영상 편집에 적합한 게이밍 데스크탑입니다.', 1490000, 6, 890, 'ON_SALE', NOW(), NULL),
    (13, 5, 'Samsung Smart Monitor M7 32형', '업무와 콘텐츠 감상을 함께 할 수 있는 스마트 모니터입니다.', 459000, 20, 650, 'ON_SALE', NOW(), NULL),
    (14, 5, 'LG UltraGear 27형 144Hz', '부드러운 화면 전환을 지원하는 게이밍 모니터입니다.', 399000, 17, 1120, 'ON_SALE', NOW(), NULL),
    (15, 5, 'Dell UltraSharp 27형 QHD', '색 정확도가 뛰어난 업무용 QHD 모니터입니다.', 529000, 9, 330, 'ON_SALE', NOW(), NULL),
    (16, 6, 'Logitech MX Keys S', '조용한 타건감과 멀티 디바이스 연결을 지원하는 키보드입니다.', 159000, 30, 780, 'ON_SALE', NOW(), NULL),
    (17, 6, 'Logitech MX Master 3S', '정밀한 스크롤과 편안한 그립감을 제공하는 무선 마우스입니다.', 139000, 32, 810, 'ON_SALE', NOW(), NULL),
    (18, 6, 'Keychron K8 Pro', '핫스왑을 지원하는 텐키리스 기계식 키보드입니다.', 149000, 15, 470, 'ON_SALE', NOW(), NULL),
    (19, 7, 'AirPods Pro 3', '노이즈 캔슬링과 공간 음향을 지원하는 무선 이어폰입니다.', 359000, 24, 1460, 'ON_SALE', NOW(), NULL),
    (20, 7, 'Sony WH-1000XM6', '강력한 노이즈 캔슬링을 제공하는 무선 헤드폰입니다.', 499000, 13, 990, 'ON_SALE', NOW(), NULL),
    (21, 7, 'Galaxy Buds 4 Pro', '안정적인 착용감과 선명한 통화 품질을 제공하는 이어폰입니다.', 269000, 26, 730, 'ON_SALE', NOW(), NULL),
    (22, 8, 'JBL Flip 7', '야외에서 사용하기 좋은 휴대용 블루투스 스피커입니다.', 169000, 21, 360, 'ON_SALE', NOW(), NULL),
    (23, 8, 'Bose SoundLink Max', '풍부한 저음과 선명한 사운드를 제공하는 블루투스 스피커입니다.', 459000, 8, 440, 'ON_SALE', NOW(), NULL),
    (24, 9, 'Apple Watch Series 11', '운동 기록과 건강 관리를 지원하는 스마트워치입니다.', 599000, 19, 1210, 'ON_SALE', NOW(), NULL),
    (25, 9, 'Galaxy Watch 8', '수면, 운동, 심박 측정을 지원하는 안드로이드 스마트워치입니다.', 399000, 23, 930, 'ON_SALE', NOW(), NULL),
    (26, 10, 'Canon EOS R50 Kit', '입문자에게 적합한 미러리스 카메라 렌즈 키트입니다.', 899000, 5, 270, 'ON_SALE', NOW(), NULL),
    (27, 10, 'Sony ZV-E10 II', '브이로그와 영상 촬영에 적합한 미러리스 카메라입니다.', 1090000, 4, 560, 'ON_SALE', NOW(), NULL),
    (28, 11, 'PlayStation 5 Slim', '고성능 콘솔 게임을 즐길 수 있는 플레이스테이션 본체입니다.', 688000, 11, 1360, 'ON_SALE', NOW(), NULL),
    (29, 11, 'Nintendo Switch OLED', '휴대와 거치 플레이를 모두 지원하는 콘솔 게임기입니다.', 415000, 18, 1010, 'ON_SALE', NOW(), NULL),
    (30, 12, 'Samsung 990 PRO SSD 1TB', '빠른 읽기/쓰기 속도를 제공하는 NVMe SSD입니다.', 159000, 34, 690, 'ON_SALE', NOW(), NULL),
    (31, 12, 'WD My Passport 2TB', '사진과 문서를 보관하기 좋은 휴대용 외장하드입니다.', 119000, 27, 240, 'ON_SALE', NOW(), NULL),
    (32, 12, 'SanDisk Extreme Portable SSD 1TB', '휴대성과 내구성을 갖춘 외장 SSD입니다.', 179000, 16, 510, 'ON_SALE', NOW(), NULL),
    (33, 13, 'ipTIME AX3000 공유기', 'Wi-Fi 6를 지원하는 가정용 무선 공유기입니다.', 89000, 38, 430, 'ON_SALE', NOW(), NULL),
    (34, 13, 'TP-Link Deco Mesh 2팩', '넓은 공간에서 안정적인 와이파이를 제공하는 메시 공유기입니다.', 229000, 12, 390, 'ON_SALE', NOW(), NULL),
    (35, 14, '65W GaN 고속 충전기', '노트북과 스마트폰을 함께 충전할 수 있는 고속 충전기입니다.', 49000, 55, 880, 'ON_SALE', NOW(), NULL),
    (36, 14, 'USB-C to C 케이블 2m', '고속 충전과 데이터 전송을 지원하는 USB-C 케이블입니다.', 15000, 100, 720, 'ON_SALE', NOW(), NULL),
    (37, 14, 'MagSafe 무선 충전 패드', '자석 정렬을 지원하는 무선 충전 패드입니다.', 59000, 42, 600, 'ON_SALE', NOW(), NULL),
    (38, 15, 'Intel Core i7 프로세서', '게이밍과 작업용 PC에 적합한 고성능 CPU입니다.', 459000, 9, 450, 'ON_SALE', NOW(), NULL),
    (39, 15, 'NVIDIA RTX 4070 그래픽카드', 'QHD 게이밍과 그래픽 작업에 적합한 그래픽카드입니다.', 899000, 3, 1180, 'ON_SALE', NOW(), NULL),
    (40, 15, 'DDR5 32GB 메모리', '고성능 데스크탑 구성을 위한 DDR5 메모리입니다.', 149000, 20, 340, 'ON_SALE', NOW(), NULL),
    (41, 16, 'Dyson V12 무선 청소기', '강력한 흡입력을 제공하는 무선 청소기입니다.', 749000, 8, 670, 'ON_SALE', NOW(), NULL),
