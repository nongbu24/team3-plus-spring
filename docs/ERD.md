...
| 주문 상태 | status | VARCHAR(30) | NOT NULL | READY, PAYMENT_PENDING, COMPLETED, CANCELED, REFUND_REQUESTED, REFUNDED |
...
| 결제 상태 | status | VARCHAR(30) | NOT NULL | PENDING, PAID, FAILED, CANCEL_REQUESTED, CANCELED, REVIEW_REQUIRED, REFUNDED |
